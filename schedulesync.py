...
PERSON_ID = flags.person[0] # Reverse-engineered JS-query http://oreluniver.ru/schedule
CALENDAR_ID = flags.calendar[0] 
QUERY = 'http://oreluniver.ru/schedule//%s///%s/printschedule' # Reverse-engineered JS-query http://oreluniver.ru/schedule
